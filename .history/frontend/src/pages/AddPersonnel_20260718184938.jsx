...
export default function AddPersonnel() {
  ...
  const sectionClass = "bg-slate-900 border border-slate-800 rounded-2xl p-6"
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="border-b border-slate-800 bg-slate-950/80 backdrop-blur-sm shrink-0">
          <div className="max-w-screen-2xl mx-auto w-full px-8 sm:px-12 lg:px-20 py-5">
        ...
        {/* Main Content */}
        <div className="flex-1 max-w-screen-2xl mx-auto w-full px-8 sm:px-12 lg:px-20 py-8">
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-xl border border-blue-400/15 bg-blue-500/5 p-4">
                ...
                <p className="text-xs text-slate-500 leading-5">
                  ...
                  generated and the FAISS search index updated immediately.
                </p>
              </div>
