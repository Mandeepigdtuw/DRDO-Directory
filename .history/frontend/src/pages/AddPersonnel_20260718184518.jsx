...
import { Loader2, Plus, X, UserPlus, ChevronRight, CheckCircle2 } from 'lucide-react'
...
export default function AddPersonnel() {
  ...
  const sectionClass = "bg-slate-900 border border-slate-700/60 rounded-2xl p-6"
        ...
        <div className="border-b border-slate-800 bg-slate-950/80 backdrop-blur-sm">
          <div className="w-full px-6 sm:px-10 lg:px-16 py-5">
            ...
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-blue-400/20 bg-blue-500/10 shrink-0">
        ...
        <div className="w-full px-6 sm:px-10 lg:px-16 py-8">
          ...
          {success && (
            <div className="bg-green-500/10 border border-green-400/20 text-green-300 text-sm rounded-xl px-4 py-3 mb-6 flex items-center gap-2">
              ...
              <p>Personnel added successfully! Redirecting...</p>
            </div>
          )}
              ...
              <div className={sectionClass}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      name="lab_acronym"
                      value={form.lab_acronym}
                      onChange={handleChange}
                      placeholder="e.g. LRDE"
                      className={inputClass}
                    />
                  </div>
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="e.g. Electronics & Radar"
                      className={inputClass}
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={form.email}
                      onChange={handleChange}
                      placeholder="e.g. name@lab.drdo.in"
                      className={inputClass}
                    />
                  </div>
                </div>
            ...
            <div className="space-y-5">
              ...
              <div className={sectionClass}>
                ...
                <div className="flex gap-2 mb-3">
                  ...
                  <button
                    ...
                    className="bg-blue-600 hover:bg-blue-500 text-white px-3 rounded-xl text-sm transition flex items-center justify-center shrink-0"
                  >
                    <Plus size={15} />
                  </button>
                </div>
                <div className="flex flex-wrap gap-2 min-h-8">
                  {form.area_of_expertise.length === 0 && (
                    <p className="text-slate-600 text-xs italic">No expertise added yet</p>
                  )}
              ...
              <div className={sectionClass}>
                ...
                <div className="flex flex-wrap gap-2 min-h-8">
                  {form.projects_associated.length === 0 && (
                    <p className="text-slate-600 text-xs italic">No projects added yet</p>
                  )}
              ...
              <div className="rounded-xl border border-blue-400/15 bg-blue-500/5 p-4">
                ...
                <p className="text-xs text-slate-500 leading-5">
                  ...
                  generated for this record and the FAISS search index will be
                  updated immediately so this person appears in search results.
                </p>
              </div>
