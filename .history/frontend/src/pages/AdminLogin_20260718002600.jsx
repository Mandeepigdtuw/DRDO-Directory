      ...
      <div className="mx-auto w-full max-w-4xl">
        <div className="rounded-[36px] border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl shadow-slate-950/20 overflow-hidden lg:grid lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="relative overflow-hidden px-8 py-10 sm:px-10 sm:py-12 lg:px-12 lg:py-14">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.22),_transparent_32%),radial-gradient(circle_at_bottom_right,_rgba(56,189,248,0.18),_transparent_28%)]" />
          ...
          <div className="px-8 py-10 sm:px-10 sm:py-12 lg:px-12 lg:py-14">
            ...
            <div className="space-y-5">
              ...
              <button
                onClick={handleLogin}
                disabled={loading}
                className="flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-sky-500 to-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-sky-500/20 transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-70"
              >
