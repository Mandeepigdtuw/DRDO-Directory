          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input name="years_of_experience" type="number"
                value={form.years_of_experience} onChange={handleChange} className={inputClass} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              ...
              <button
                ...
                className="bg-blue-600 hover:bg-blue-500 text-white px-4 rounded-xl text-sm transition-colors flex items-center gap-1 shrink-0"
              >
                <Plus size={14} /> Add
              </button>
            </div>
