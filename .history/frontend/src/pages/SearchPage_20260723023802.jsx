      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="flex flex-col items-center justify-center px-6 pt-20 pb-12">
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-blue-400 text-xs font-semibold uppercase tracking-[0.25em]">
              Intelligent Personnel Search
            </span>
          </div>

          {/* Title */}
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white text-center leading-tight mb-5">
            DRDO Personnel
          ...
          {/* Subtitle */}
          <p className="text-slate-400 text-center text-base sm:text-lg max-w-xl leading-relaxed mb-10">
          ...
          <div className="w-full max-w-3xl flex gap-3 mb-5">
            <div className="flex-1 flex items-center bg-slate-900 border border-slate-700 hover:border-slate-500 focus-within:border-blue-500 focus-within:ring-4 focus-within:ring-blue-500/10 rounded-2xl px-5 gap-4 transition-all">
              ...
              <input
                ...
                className="flex-1 bg-transparent text-white py-5 outline-none placeholder-slate-500 text-base"
              />
              {query && (
                <button
            ...
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-sky-500 hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed text-white px-8 rounded-2xl font-semibold text-base shadow-lg shadow-blue-500/20 transition whitespace-nowrap"
            >
              {loading
          ...
          <div className="flex flex-wrap gap-2 justify-center max-w-3xl mb-12">
            {hints.map((hint) => (
              <button
                ...
                className="text-xs text-slate-400 hover:text-blue-300 bg-slate-900 hover:bg-slate-800 border border-slate-700 hover:border-blue-500/40 px-4 py-2 rounded-full transition-all"
              >
                {hint}
              </button>
            ))}
        ...
        {/* Results Section */}
        <div className="flex-1 w-full px-6 sm:px-10 lg:px-16 pb-16">

          {error && (
            <div className="text-red-400 bg-red-400/10 border border-red-400/20 rounded-xl p-4 text-center mb-6 text-sm max-w-3xl mx-auto">
              {error}
            </div>
          )}
