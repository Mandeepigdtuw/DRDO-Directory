    ...
    <nav className="w-full border-b border-white/10 bg-slate-950/90 backdrop-blur-xl">
      <div className="flex h-16 w-full items-center justify-between px-6 sm:px-10 lg:px-16">
        ...
        <div className="flex items-center gap-1">
          <Link
            to="/"
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium text-slate-400 hover:text-white hover:bg-white/5 transition"
          >
            <Search size={14} />
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium text-slate-400 hover:text-red-400 hover:bg-red-400/5 border border-transparent hover:border-red-400/20 transition shrink-0"
        >
          <LogOut size={14} />
